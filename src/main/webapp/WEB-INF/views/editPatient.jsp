...
<div class="col-md-6">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="<%=request.getContextPath()%>/patients/update" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="phone" class="form-control" id="address" name="address" value="${patient.address }" required>
                </div>
                <div class="form-group">
                    <label for="emailId">Email:</label>
                    <input type="email" class="form-control" id="emailId" name="emailId" value="${patient.emailId }" required>
                </div>
